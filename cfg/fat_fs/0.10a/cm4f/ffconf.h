...
#define _FS_TIMEOUT		OS_TIMEOUT_FS	/* Timeout period in unit of time ticks */
#define	_SYNC_t			OS_FILE_SYSTEM_SYNC_OBJ	/* O/S dependent sync object type. e.g. HANDLE, OS_EVENT*, ID and etc.. */
/*#include <windows.h>*/
