...
#define	_FS_TINY		OS_FILE_SYSTEM_TINY	/* 0:Normal or 1:Tiny */
...
#define _FS_READONLY	OS_FILE_SYSTEM_READONLY	/* 0:Read/Write or 1:Read only */
/* Setting _FS_READONLY to 1 defines read only configuration. This removes
/  writing functions, f_write(), f_sync(), f_unlink(), f_mkdir(), f_chmod(),
/  f_rename(), f_truncate() and useless f_getfree(). */


#define _FS_MINIMIZE	OS_FILE_SYSTEM_MINIMIZE	/* 0 to 3 */
...
#define	_USE_STRFUNC	OS_FILE_SYSTEM_STRFUNC_EN	/* 0:Disable or 1-2:Enable */
/* To enable string functions, set _USE_STRFUNC to 1 or 2. */


#define	_USE_MKFS		OS_FILE_SYSTEM_MAKE_ENABLED	/* 0:Disable or 1:Enable */
/* To enable f_mkfs() function, set _USE_MKFS to 1 and set _FS_READONLY to 0 */


#define	_USE_FASTSEEK	OS_FILE_SYSTEM_FASTSEEK	/* 0:Disable or 1:Enable */
/* To enable fast seek feature, set _USE_FASTSEEK to 1. */


#define _USE_LABEL		OS_FILE_SYSTEM_LABEL_EN	/* 0:Disable or 1:Enable */
/* To enable volume label functions, set _USE_LAVEL to 1 */


#define	_USE_FORWARD	OS_FILE_SYSTEM_FORWARD_EN	/* 0:Disable or 1:Enable */
...
#define _CODE_PAGE	OS_FILE_SYSTEM_CODEPAGE
...
#define	_USE_LFN	OS_FILE_SYSTEM_LONG_NAMES_ENABLED		/* 0 to 3 */
#define	_MAX_LFN	OS_FILE_SYSTEM_LONG_NAMES_LEN		/* Maximum LFN length to handle (12 to 255) */
...
#define	_LFN_UNICODE	OS_FILE_SYSTEM_LONG_NAMES_UNICODE	/* 0:ANSI/OEM or 1:Unicode */
...
#define _STRF_ENCODE	OS_FILE_SYSTEM_STRF_ENCODE	/* 0:ANSI/OEM, 1:UTF-16LE, 2:UTF-16BE, 3:UTF-8 */
...
#define _FS_RPATH		OS_FILE_SYSTEM_REL_PATH	/* 0 to 2 */
...
#define _VOLUMES	OS_FILE_SYSTEM_VOLUMES_MAX
...
#define	_MULTI_PARTITION	OS_FILE_SYSTEM_MULTI_PART	/* 0:Single partition, 1:Enable multiple partition */
...
#define	_USE_ERASE	OS_FILE_SYSTEM_ERASE_SEC_EN	/* 0:Disable or 1:Enable */
/* To enable sector erase feature, set _USE_ERASE to 1. Also CTRL_ERASE_SECTOR command
/  should be added to the disk_ioctl() function. */


#define _FS_NOFSINFO	OS_FILE_SYSTEM_NO_INFO	/* 0 to 3 */
...
#define	_FS_LOCK	OS_FILE_SYSTEM_LOCK	/* 0:Disable or >=1:Enable */
...
#include "os_mutex.h"
#define _FS_REENTRANT	OS_FILE_SYSTEM_REENTRANT		/* 0:Disable or 1:Enable */
#define _FS_TIMEOUT		OS_TIMEOUT_FS	/* Timeout period in unit of time tick */
#define	_SYNC_t			OS_FILE_SYSTEM_SYNC_OBJ	/* O/S dependent sync object type. e.g. HANDLE, OS_EVENT*, ID, SemaphoreHandle_t and etc.. */
...
#define _WORD_ACCESS	OS_FILE_SYSTEM_WORD_ACCESS	/* 0 or 1 */
