 ...
 */
#define UNITY_OUTPUT_CHAR(a)    HAL_putchar(a)
#define UNITY_OUTPUT_FLUSH      HAL_fflush
#define UNITY_OUTPUT_START      HAL_fflush
#define UNITY_OUTPUT_COMPLETE   HAL_fflush
