...
#ifdef IWDG_ENABLED
    IF_STATUS(s = IWDG_Init_()) { return s; }
//    IF_STATUS(s = drv_iwdg_v[DRV_ID_IWDG]->Init()) { return s; }
//    IF_STATUS(s = drv_iwdg_v[DRV_ID_IWDG]->Open(OS_NULL)) { return s; }
#endif // IWDG_ENABLED
